...
export const apiConfig = {
  ...
  groups: {
    ...
    members: (groupId: string) => `${API_BASE_URL}${API_GROUP_URL}/${groupId}/members`,
    tasks: (groupId: string) => `${API_BASE_URL}${API_GROUP_URL}/${groupId}/tasks`,
    taskById: (groupId: string, taskId: string) => `${API_BASE_URL}${API_GROUP_URL}/${groupId}/tasks/${taskId}`,
  },
  users: {
